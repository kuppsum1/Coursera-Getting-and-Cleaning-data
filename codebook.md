    ...
    average-timeBodyAccelerationJerkMagnitude-mean
            The average of the mean values of the magnitude of the Jerk signals of the body linear acceleration  
            derived in time
    average-timeBodyAccelerationJerkMagnitude-std_deviation
    ...
    average-frequencyBodyAcceleration-meanFreq-X-axis
            ...
            for each activity and each subject
    average-frequencyBodyAcceleration-meanFreq-Y-axis
            The average of the weighted average of the frequency       
            components to obtain a mean frequency of the frequency domain of the body acceleration signal for Y-axis 
            for each activity and each subject
    average-frequencyBodyAcceleration-meanFreq-Z-axis
            The average of the weighted average of the frequency       
            components to obtain a mean frequency of the frequency domain of the body acceleration signal for Z-axis 
            for each activity and each subject
    average-frequencyBodyAccelerationJerk-mean-X-axis
            The average of the mean values of the Jerk signals of the body linear acceleration derived in frequency 
            for X-axis
    average-frequencyBodyAccelerationJerk-mean-Y-axis
            The average of the mean values of the Jerk signals of the body linear acceleration derived in frequency 
            for Y-axis
    average-frequencyBodyAccelerationJerk-mean-Z-axis
            The average of the mean values of the Jerk signals of the body linear acceleration derived in frequency 
            for Z-axis
    average-frequencyBodyAccelerationJerk-std_deviation-X-axis
            The average of the standard deviation values of the Jerk signals of the body linear acceleration derived  
            in frequency for X-axis
    average-frequencyBodyAccelerationJerk-std_deviation-Y-axis
            The average of the standard deviation values of the Jerk signals of the body linear acceleration derived  
            in frequency for Y-axis
    average-frequencyBodyAccelerationJerk-std_deviation-Z-axis
            The average of the standard deviation values of the Jerk signals of the body linear acceleration derived  
            in frequency for Z-axis
    average-frequencyBodyAccelerationJerk-meanFreq-X-axis 
            The average of the weighted average of the frequency       
